...
int main (){
    ...
    // Input file tanaman
    printf("Selamat datang di database kota Provinsi Jawa Barat.\n");
    printf("Silahkan masukkan nama file database nama kota di Jawa Barat: ");
    ...
    printf("Pembacaan nama kota di Jawa Barat berhasil.\n");
    ...
    while(progress=='y'){
        ...
        printf("\nBerikut adalah daftar nama kota yang berada di Provinsi Jawa Barat.\n");
        ...
        printf("Apakah anda masih ingin berkunjung di Kota Provinsi Jawa Barat? [y/n]: ");
        scanf(" %c",&progress);
    }
}
